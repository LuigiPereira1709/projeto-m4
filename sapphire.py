...
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_y', data=data_all, label='December', color='blue', palette='pastel', marker='s', ax=axes[0,0])
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_x', data=data_all, label='November', color='red', palette='pastel', marker='o', ax=axes[0,0])
...
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_x', data=data[data['Produto_x'] == product[0]], label='December', color='blue', palette='pastel', marker='o', ax=axes[0,1])
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_y', data=data[data['Produto_y'] == product[0]], label='November', color='red', palette='pastel',marker='s', ax=axes[0,1])
...
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_x', data=data[data['Produto_x'] == product[1]], label='December', palette='pastel',color='red', marker='s', ax=axes[1,0])
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_y', data=data[data['Produto_y'] == product[1]], label='November', color='blue', palette='pastel', marker='o', ax=axes[1,0])
...
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_x', data=data[data['Produto_x'] == product[2]], label='December', color='blue', palette='pastel', marker='o', ax=axes[1,1])
sns.lineplot(x='Dia da Coleta', y='Valor de Venda_y', data=data[data['Produto_y'] == product[2]], label='November', color='red',  palette='pastel', marker='s', ax=axes[1,1])
